...
FINS_REPO=https://bitbucket.org/hww3
...
# 	ibtool --strings-file ${CASTER_CONTROL}.app/Contents/Resources/French.lproj/Caster.strings --write ${CASTER_CONTROL}.app/Contents/Resources/French.lproj/Caster.nib ${CASTER_CONTROL}.app/Contents/Resources/English.lproj/Caster.nib
...
deploy: prereqs
	mkdir -p "${DEPLOY_DEST}"
	if [ -f "${DEPLOY_DEST}"/Keyboard.sqlite3 ] ; then cp "${DEPLOY_DEST}"/Keyboard.sqlite3 "${DEPLOY_DEST}"/Keyboard.sqlite3.`date +"%Y%m%d%H%M"` ; else echo "No database to back up." ; fi
...
#	ibtool --strings-file ${RIBBON_GENERATOR}.app/Contents/Resources/French.lproj/MainMenu.strings --write ${RIBBON_GENERATOR}.app/Contents/Resources/French.lproj/MainMenu.nib ${RIBBON_GENERATOR}.app/Contents/Resources/English.lproj/MainMenu.nib
